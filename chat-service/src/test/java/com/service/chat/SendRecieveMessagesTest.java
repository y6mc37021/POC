...
class SendRecieveMessagesTest {
	...
	public void sendRecieveMessage() throws Exception {
		...
		Assertions.assertEquals(message, recivedMsg.getContent());
		//Assertions.assertEquals(message, blockingQueue.poll(5, TimeUnit.SECONDS));
	}
